...
public class Exemplo {
    ...
    public static void chamarCalculadora(char operacao) {
        ...
        switch (operacao) {
            case '+' ->
                System.out.println("Soma = " + soma(num[0], num[1]));

            case '-' ->
                System.out.println("Subtracao = " + subtrai(num[0], num[1]));

            case '*' ->
                System.out.println("Multiplicacao = " + multiplica(num[0], num[1]));
    ...
    public static int[] entrada() {
        ...
        for (int i = 0; i < numeros.length; i++) {
            System.out.println("Digite os numeros numero");
